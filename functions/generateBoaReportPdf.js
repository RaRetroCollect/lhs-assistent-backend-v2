...
module.exports = {
  generateBoaReportPdf: async function (rapportPkeyRecord, email) {
    try {
      const query = sql`
        SELECT  r.pkey, r.score_e1, r.score_e2, r.score_e3, r.score_e4,
                r.score_e5, r.score_e6, r.score_e7, r.score_e8, r.score_g1,
                r.score_g2, r.score_g3, r.score_g4, r.score_g5, r.score_g6, 
                r.score_g7, r.score_g8, r.medewerker, r.datum, r.score_s1,
                r.score_s2 , r.score_s3 , r.score_s4, r.score_s5 , r.score_s6,
                r.score_s7, r.s4_tekst, r.s5_toelichting, r.locatie, r.omschrijving,
                r.gscore_calc_total, r.escore_calc_total, r.gscore_mutareden,
                r.escore_mutareden, r.gscore_afwijken, r.escore_afwijken, 
                r.gscore_letter, r.escore_cijfer, r.ernstq7atekst, r.gedragq8tekst,
                r.gedragq9tekst, r.toelichting_e4, r.toelichting_e6, g.gemeente, r.strat_opmerking
            FROM rapporten r
      ...
      let tekstE1 = teksten.E1;
      let tekstE2 = teksten.E2;
      let tekstE3 = teksten.E3;
      let tekstE4 = teksten.E4;
      let tekstE5 = teksten.E5;
      let tekstE6 = teksten.E6;
      let tekstE7 = teksten.E7;
      let tekstE7A = teksten.E7A;
      let tekstE8 = teksten.E8;
      let tekstG1 = teksten.G1;
      let tekstG2 = teksten.G2;
      let tekstG3 = teksten.G3;
      let tekstG4 = teksten.G4;
      let tekstG5 = teksten.G5;
      let tekstG6 = teksten.G6;
      let tekstG7 = teksten.G7;
      let tekstG8 = teksten.G8;
      let tekstG9 = teksten.G9;
      let tekstS1 = teksten.S1;
      let tekstS2 = teksten.S2;
      let tekstS3 = teksten.S3;
      let tekstS4 = teksten.S4;
      let tekstS5 = teksten.S5;
      let tekstS6 = teksten.S6;
      let tekstS7 = teksten.S7;
      ...
      if (result.strat_opmerking.length > 0) {
        html +=
          /*html*/
          `
          <br />Opmerkingen / conclusies:<br />${result.strat_opmerking}
          `;
      }
