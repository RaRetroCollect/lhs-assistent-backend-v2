...
module.exports = {
  generateReportPdf: async function (rapportPkeyRecord, email, boaMail, user) {
    try {
      const query =
        `SELECT r.pkey, r.score_e1 , r.score_e2 , r.score_e3 , r.score_e4 , ` +
        `r.score_e5 , r.score_e6 , r.score_e7 , r.score_e8 , ` +
        `r.score_g1 , r.score_g2 , r.score_g3 , r.score_g4 , r.toelichting_e4, ` +
        `r.score_g5 , r.score_g6 , r.toelichting_e6, r.score_g7, r.datum , r.medewerker , ` +
